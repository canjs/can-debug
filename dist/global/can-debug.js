...
/*can-debug@1.2.1#src/proxy-namespace*/
...
/*can-debug@1.2.1#src/temporarily-bind*/
...
/*can-debug@1.2.1#src/graph/graph*/
...
/*can-debug@1.2.1#src/get-graph/make-node*/
...
/*can-debug@1.2.1#src/get-graph/get-graph*/
...
/*can-debug@1.2.1#src/draw-graph/format-graph*/
define('can-debug/src/draw-graph/format-graph', [
    'require',
    'exports',
    'module',
    'can-reflect'
...
/*can-debug@1.2.1#src/draw-graph/draw-graph*/
define('can-debug/src/draw-graph/draw-graph', [
    'require',
    'exports',
    'module',
    'can-debug/src/draw-graph/format-graph',
    'can-debug/src/get-graph/get-graph'
], function (require, exports, module) {
    (function (__dirname, require, exports, module) {
        var formatGraph = require('can-debug/src/draw-graph/format-graph');
...
/*can-debug@1.2.1#src/log-data/log-data*/
...
/*can-debug@1.2.1#src/label-cycles/label-cycles*/
...
/*can-debug@1.2.1#src/get-data/get-data*/
...
/*can-debug@1.2.1#src/what-i-change/what-i-change*/
...
/*can-debug@1.2.1#src/what-changes-me/what-changes-me*/
...
/*can-debug@1.2.1#src/get-what-i-change/get-what-i-change*/
...
/*can-debug@1.2.1#src/get-what-changes-me/get-what-changes-me*/
...
define('can-debug', [
    ...
    'can-debug/src/get-graph/get-graph',
    'can-debug/src/draw-graph/format-graph',
    'can-debug/src/draw-graph/draw-graph',
    ...
    (function (global, require, exports, module) {
        ...
        var getGraph = require('can-debug/src/get-graph/get-graph');
        var formatGraph = require('can-debug/src/draw-graph/format-graph');
        var drawGraph = require('can-debug/src/draw-graph/draw-graph');
