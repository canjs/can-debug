# Contributing to can-debug

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/Bitovi/can-debug) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-debug, you can start by going to its [fork page](https://github.com/Bitovi/can-debug/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-debug
```
